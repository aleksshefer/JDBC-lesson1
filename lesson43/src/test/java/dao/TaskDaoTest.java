...
class TaskDaoTest {
    ...
    public void testGetByIdReturnsCorrectTask() {
        Task task = new Task("test task", false, LocalDateTime.of(2023, Month.NOVEMBER, 23, 10,10,10));
        taskDao.save(task);
    ...
    public void testFindNotFinishedReturnsCorrectTasks() {
        Task unfinishedTask = new Task("test task", false, LocalDateTime.of(2023, Month.NOVEMBER, 23, 10,10,10));
        taskDao.save(unfinishedTask);

        Task finishedTask = new Task("test task", true, LocalDateTime.of(2023, Month.NOVEMBER, 23, 10,10,10));
